...
const BLOCKLISTS: Record<string, string[]> = {
  low: [
    'kill yourself', 'kys', 'suicide instructions', 'how to make a bomb',
    'how to hack', 'racial slur',
  ],
  medium: [
    'kill yourself', 'kys', 'suicide instructions', 'how to make a bomb',
    'how to hack', 'racial slur', 'hate speech', 'violence',
    'explicit content', 'illegal activity',
  ],
  high: [
    'kill yourself', 'kys', 'suicide instructions', 'how to make a bomb',
    'how to hack', 'racial slur', 'hate speech', 'violence',
    'explicit content', 'illegal activity', 'weapon', 'drug',
    'exploit', 'abuse', 'harass', 'threat', 'discriminat',
  ],
};
...
export class ToxicityEvaluator {
  ...
  constructor(config?: ToxicityConfig) {
    ...
    this.blocklist = [
      ...BLOCKLISTS[this.sensitivity],
      ...(config?.customBlocklist || []),
    ];
